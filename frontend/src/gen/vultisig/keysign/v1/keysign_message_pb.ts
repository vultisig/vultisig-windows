...
import { CosmosSpecific, EthereumSpecific, MAYAChainSpecific, PolkadotSpecific, SolanaSpecific, SuiSpecific, THORChainSpecific, UTXOSpecific } from "./blockchain_specific_pb.js";
...
export class KeysignMessage extends Message<KeysignMessage> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "use_vultisig_relay", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): KeysignMessage {
    return new KeysignMessage().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): KeysignMessage {
    return new KeysignMessage().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): KeysignMessage {
    return new KeysignMessage().fromJsonString(jsonString, options);
  }

  static equals(a: KeysignMessage | PlainMessage<KeysignMessage> | undefined, b: KeysignMessage | PlainMessage<KeysignMessage> | undefined): boolean {
...
export class KeysignPayload extends Message<KeysignPayload> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "utxo_specific", kind: "message", T: UTXOSpecific, oneof: "blockchain_specific" },
    { no: 5, name: "ethereum_specific", kind: "message", T: EthereumSpecific, oneof: "blockchain_specific" },
    { no: 6, name: "thorchain_specific", kind: "message", T: THORChainSpecific, oneof: "blockchain_specific" },
    { no: 7, name: "maya_specific", kind: "message", T: MAYAChainSpecific, oneof: "blockchain_specific" },
    { no: 8, name: "cosmos_specific", kind: "message", T: CosmosSpecific, oneof: "blockchain_specific" },
    { no: 9, name: "solana_specific", kind: "message", T: SolanaSpecific, oneof: "blockchain_specific" },
    { no: 10, name: "polkadot_specific", kind: "message", T: PolkadotSpecific, oneof: "blockchain_specific" },
    { no: 11, name: "suiche_specific", kind: "message", T: SuiSpecific, oneof: "blockchain_specific" },
    { no: 20, name: "utxo_info", kind: "message", T: UtxoInfo, repeated: true },
    { no: 21, name: "memo", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 22, name: "thorchain_swap_payload", kind: "message", T: THORChainSwapPayload, oneof: "swap_payload" },
    { no: 23, name: "mayachain_swap_payload", kind: "message", T: THORChainSwapPayload, oneof: "swap_payload" },
    { no: 24, name: "oneinch_swap_payload", kind: "message", T: OneInchSwapPayload, oneof: "swap_payload" },
    { no: 30, name: "erc20_approve_payload", kind: "message", T: Erc20ApprovePayload, opt: true },
    { no: 31, name: "vault_public_key_ecdsa", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 32, name: "vault_local_party_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): KeysignPayload {
    return new KeysignPayload().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): KeysignPayload {
    return new KeysignPayload().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): KeysignPayload {
    return new KeysignPayload().fromJsonString(jsonString, options);
  }

  static equals(a: KeysignPayload | PlainMessage<KeysignPayload> | undefined, b: KeysignPayload | PlainMessage<KeysignPayload> | undefined): boolean {
