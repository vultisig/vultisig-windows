...
export class UtxoInfo extends Message<UtxoInfo> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UtxoInfo {
    return new UtxoInfo().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UtxoInfo {
    return new UtxoInfo().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UtxoInfo {
    return new UtxoInfo().fromJsonString(jsonString, options);
  }

  static equals(a: UtxoInfo | PlainMessage<UtxoInfo> | undefined, b: UtxoInfo | PlainMessage<UtxoInfo> | undefined): boolean {
