...
export class THORChainSwapPayload extends Message<THORChainSwapPayload> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "vault_address", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "router_address", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 6, name: "from_amount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "to_amount_decimal", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 8, name: "to_amount_limit", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 9, name: "streaming_interval", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 10, name: "streaming_quantity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 11, name: "expiration_time", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 12, name: "is_affiliate", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): THORChainSwapPayload {
    return new THORChainSwapPayload().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): THORChainSwapPayload {
    return new THORChainSwapPayload().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): THORChainSwapPayload {
    return new THORChainSwapPayload().fromJsonString(jsonString, options);
  }

  static equals(a: THORChainSwapPayload | PlainMessage<THORChainSwapPayload> | undefined, b: THORChainSwapPayload | PlainMessage<THORChainSwapPayload> | undefined): boolean {
