export const pt = {
  ...
  send_terms_error: 'Você precisa aceitar os termos',
  ...
  secure: 'Seguro',
  active: 'Ativo',
  fast_vault_setup_prop_0: 'Configuração de dispositivo único',
  fast_vault_setup_prop_1: 'Alertas e políticas de transações',
  fast_vault_setup_prop_2: 'Backup do Vault enviado por e-mail',
  ...
  secure_vault_setup_prop_0: 'Somente seus dispositivos',
  secure_vault_setup_prop_1: 'Nenhum alerta ou política',
  secure_vault_setup_prop_2: 'Totalmente autocustódia',
