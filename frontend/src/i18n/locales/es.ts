export const es = {
  ...
  secure: 'Seguro',
  active: 'Activo',
  fast_vault_setup_prop_0: 'Configuración de un solo dispositivo',
  fast_vault_setup_prop_1: 'Alertas y políticas de transacciones',
  fast_vault_setup_prop_2:
    'Copia de seguridad de la bóveda enviada por correo electrónico',
