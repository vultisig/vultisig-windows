...
export class FinalSession {
    ...
    constructor(setup, id, pre) {
        ...
        var ptr2 = pre.__destroy_into_raw();
        const ret = wasm.finalsession_new(ptr0, len0, ptr1, len1, ptr2);
        if (ret[2]) {
    ...
    static setup(session_id, message_hash, ids) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.finalsession_setup(ptr0, len0, message_hash, ptr1, len1);
        if (ret[3]) {
    ...
    static setupMessageHash(setup_msg) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.finalsession_setupMessageHash(ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
    ...
    static setupKeyId(setup_msg) {
        const ptr0 = passArray8ToWasm0(setup_msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.finalsession_setupKeyId(ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
            v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    finish() {
        const ret = wasm.finalsession_finish(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
...
const HardDerivationSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hardderivationsession_free(ptr >>> 0, 1));
...
export class HardDerivationSession {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        HardDerivationSessionFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_hardderivationsession_free(ptr, 0);
    }
    /**
    ...
    constructor(setup, id, share) {
        ...
        const ret = wasm.hardderivationsession_new(ptr0, len0, ptr1, len1, share.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        HardDerivationSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * Create a new HD setup message.
     *
     * # Arguments
     *
     ...
     * @returns {Uint8Array}
     */
    static setup(key_id, chain_path, ids) {
        ...
        const ret = wasm.hardderivationsession_setup(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
    ...
    static setupKeyId(setup_msg) {
        const ptr0 = passArray8ToWasm0(setup_msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hardderivationsession_setupKeyId(ptr0, len0);
        let v2;
        if (ret[0] !== 0) {
            v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    outputMessage() {
        const ret = wasm.hardderivationsession_outputMessage(this.__wbg_ptr);
        return ret === 0 ? undefined : Message.__wrap(ret);
    }
    /**
     * Handle an input message. If processing of the input message moves the
    ...
    inputMessage(msg) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hardderivationsession_inputMessage(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    finish() {
        const ret = wasm.hardderivationsession_finish(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
export class KeyExportSession {
    ...
    constructor(share, ids) {
        ...
        KeyExportSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
...
export class KeyImportSession {
    ...
    constructor(setup, id) {
        ...
        this.__wbg_ptr = ret[0] >>> 0;
        KeyImportSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * Get next output message. If no pending output message available,
...
export class KeygenSession {
    ...
    static refresh(setup, id, old_share) {
        ...
        const ret = wasm.keygensession_refresh(ptr0, len0, ptr1, len1, old_share.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
export class PreSign {
    ...
    static fromBytes(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.presign_fromBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return PreSign.__wrap(ret[0]);
    }
}
...
export class SignSession {
    ...
    static setup(key_id, chain_path, message_hash, ids) {
        ...
        const ptr2 = passArrayJsValueToWasm0(ids, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.signsession_setup(ptr0, len0, ptr1, len1, isLikeNone(message_hash) ? 0 : addToExternrefTable0(message_hash), ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
