...
export const darkTheme: DefaultTheme = {
  ...
  colors: {
    ...
    // new design system
    alertInfo: new HSLA(212.39, 100, 68.04),
    ...
    buttonsDisabled: new HSLA(220.85, 68.12, 13.53),
    textExtraLight: new HSLA(214.09, 21.36, 59.61),
    textPrimary: new HSLA(220, 66.67, 96.47),
  },
  gradients: {
