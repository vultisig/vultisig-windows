...
export class FroztDkgSession {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(FroztDkgSession.prototype);
        obj.__wbg_ptr = ptr;
        FroztDkgSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FroztDkgSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_froztdkgsession_free(ptr, 0);
    }
    /**
    ...
    feed(msg) {
        ...
        const ret = wasm.froztdkgsession_feed(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     * @returns {FroztDkgSession}
     */
    static fromSetup(setup_bytes, my_party_name, birthday) {
        ...
        const ret = wasm.froztdkgsession_fromSetup(ptr0, len0, ptr1, len1, birthday);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return FroztDkgSession.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} msg
     * @param {number} index
    ...
    msgReceiver(msg, index) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztdkgsession_msgReceiver(this.__wbg_ptr, ptr0, len0, index);
        let v2;
        if (ret[0] !== 0) {
     ...
     */
    result() {
        const ret = wasm.froztdkgsession_result(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    takeMsg() {
        const ret = wasm.froztdkgsession_takeMsg(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) FroztDkgSession.prototype[Symbol.dispose] = FroztDkgSession.prototype.free;

export class FroztKeyImportSession {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(FroztKeyImportSession.prototype);
        obj.__wbg_ptr = ptr;
        FroztKeyImportSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FroztKeyImportSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_froztkeyimportsession_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} msg
     * @returns {boolean}
    ...
    feed(msg) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztkeyimportsession_feed(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {Uint8Array} setup_bytes
     ...
     * @param {bigint} birthday
     * @returns {FroztKeyImportSession}
     */
    static fromSetup(setup_bytes, my_party_name, seed, account_index, birthday) {
        const ptr0 = passArray8ToWasm0(setup_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(my_party_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        ...
        const ret = wasm.froztkeyimportsession_fromSetup(ptr0, len0, ptr1, len1, ptr2, len2, account_index, birthday);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return FroztKeyImportSession.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} msg
     * @param {number} index
    ...
    msgReceiver(msg, index) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztkeyimportsession_msgReceiver(this.__wbg_ptr, ptr0, len0, index);
        let v2;
        if (ret[0] !== 0) {
            v2 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    result() {
        const ret = wasm.froztkeyimportsession_result(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    takeMsg() {
        const ret = wasm.froztkeyimportsession_takeMsg(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) FroztKeyImportSession.prototype[Symbol.dispose] = FroztKeyImportSession.prototype.free;

export class FroztReshareSession {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(FroztReshareSession.prototype);
        obj.__wbg_ptr = ptr;
        FroztReshareSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FroztReshareSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_froztresharesession_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} msg
     * @returns {boolean}
    ...
    feed(msg) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztresharesession_feed(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {Uint8Array} setup_bytes
    ...
    static fromSetup(setup_bytes, my_party_name, old_key_package) {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.froztresharesession_fromSetup(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return FroztReshareSession.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} msg
     * @param {number} index
    ...
    msgReceiver(msg, index) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztresharesession_msgReceiver(this.__wbg_ptr, ptr0, len0, index);
        let v2;
        if (ret[0] !== 0) {
            v2 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    result() {
        const ret = wasm.froztresharesession_result(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    takeMsg() {
        const ret = wasm.froztresharesession_takeMsg(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) FroztReshareSession.prototype[Symbol.dispose] = FroztReshareSession.prototype.free;

export class FroztSignSession {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(FroztSignSession.prototype);
        obj.__wbg_ptr = ptr;
        FroztSignSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FroztSignSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_froztsignsession_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} msg
     * @returns {boolean}
    ...
    feed(msg) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztsignsession_feed(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {Uint8Array} setup_bytes
    ...
    static fromSetup(setup_bytes, my_party_name, key_package, pub_key_package) {
        ...
        const ret = wasm.froztsignsession_fromSetup(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return FroztSignSession.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} setup_bytes
     * @param {string} my_party_name
     ...
     * @returns {FroztSignSession}
     */
    static fromSetupWithAlpha(setup_bytes, my_party_name, key_package, pub_key_package, alpha) {
        const ptr0 = passArray8ToWasm0(setup_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(my_party_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        ...
        const ptr3 = passArray8ToWasm0(pub_key_package, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArray8ToWasm0(alpha, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.froztsignsession_fromSetupWithAlpha(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return FroztSignSession.__wrap(ret[0]);
    ...
    msgReceiver(msg, index) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.froztsignsession_msgReceiver(this.__wbg_ptr, ptr0, len0, index);
        let v2;
        if (ret[0] !== 0) {
            v2 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    result() {
        const ret = wasm.froztsignsession_result(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    takeMsg() {
        const ret = wasm.froztsignsession_takeMsg(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) FroztSignSession.prototype[Symbol.dispose] = FroztSignSession.prototype.free;
...
export class WasmShieldingTxBuilder {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmShieldingTxBuilderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmshieldingtxbuilder_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} prev_txid
     * @param {number} vout
     * @param {number} value
     * @param {Uint8Array} script_pubkey
     */
    addInput(prev_txid, vout, value, script_pubkey) {
        const ptr0 = passArray8ToWasm0(prev_txid, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(script_pubkey, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshieldingtxbuilder_addInput(this.__wbg_ptr, ptr0, len0, vout, value, ptr1, len1);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    addOutput(address, amount) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshieldingtxbuilder_addOutput(this.__wbg_ptr, ptr0, len0, amount);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} amount
     */
    addTransparentOutput(address, amount) {
        const ptr0 = passStringToWasm0(address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshieldingtxbuilder_addTransparentOutput(this.__wbg_ptr, ptr0, len0, amount);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    build() {
        const ret = wasm.wasmshieldingtxbuilder_build(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    /**
     * @param {Uint8Array} ecdsa_sigs
     * @param {Uint8Array} pubkeys
     * @returns {Uint8Array}
     */
    complete(ecdsa_sigs, pubkeys) {
        const ptr0 = passArray8ToWasm0(ecdsa_sigs, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(pubkeys, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshieldingtxbuilder_complete(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     * @param {number} target_height
     */
    constructor(output_params_bytes, extras_bytes, target_height) {
        const ptr0 = passArray8ToWasm0(output_params_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(extras_bytes, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmshieldingtxbuilder_new(ptr0, len0, ptr1, len1, target_height);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WasmShieldingTxBuilderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {number}
     */
    get numInputs() {
        const ret = wasm.wasmshieldingtxbuilder_numInputs(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {Uint8Array}
     */
    get sighashes() {
        const ret = wasm.wasmshieldingtxbuilder_sighashes(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
}
if (Symbol.dispose) WasmShieldingTxBuilder.prototype[Symbol.dispose] = WasmShieldingTxBuilder.prototype.free;
 ...
 * @returns {Uint8Array}
 */
export function froztDkgSetupMsgNew(max_signers, min_signers, parties_data, birthday) {
    const ptr0 = passArray8ToWasm0(parties_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.froztDkgSetupMsgNew(max_signers, min_signers, ptr0, len0, birthday);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function froztKeyImportSetupMsgNew(max_signers, min_signers, parties_data, birthday, seed_holder_id, seed, account_index) {
    const ptr0 = passArray8ToWasm0(parties_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(seed, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.froztKeyImportSetupMsgNew(max_signers, min_signers, ptr0, len0, birthday, seed_holder_id, ptr1, len1, account_index);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function froztReshareSetupMsgNew(max_signers, min_signers, parties_data, old_identifiers_data, expected_vk) {
    const ptr0 = passArray8ToWasm0(parties_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.froztReshareSetupMsgNew(max_signers, min_signers, ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function froztSignSetupMsgNew(msg_to_sign, parties_data) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.froztSignSetupMsgNew(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {bigint}
 */
export function frozt_sapling_tree_size(hex_state) {
    const ptr0 = passStringToWasm0(hex_state, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.frozt_sapling_tree_size(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return BigInt.asUintN(64, ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./frozt_wasm_bg.js": import0,
    };
}

const FroztDkgSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_froztdkgsession_free(ptr >>> 0, 1));
const FroztKeyImportSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_froztkeyimportsession_free(ptr >>> 0, 1));
const FroztReshareSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_froztresharesession_free(ptr >>> 0, 1));
const FroztSignSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_froztsignsession_free(ptr >>> 0, 1));
...
const WasmShieldingTxBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmshieldingtxbuilder_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('frozt_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
