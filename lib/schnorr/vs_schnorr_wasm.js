...
export class FinalSession {
    ...
    constructor(setup, id, pre) {
        try {
            ...
            wasm.finalsession_new(retptr, ptr0, len0, ptr1, len1, ptr2);
     ...
     * @returns {Uint8Array}
     */
    static setup(session_id, message, ids) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            ...
            wasm.finalsession_setup(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
export class KeygenSession {
    ...
    static refresh(setup, id, old_keyshare) {
        try {
            ...
            wasm.keygensession_refresh(retptr, ptr0, len0, ptr1, len1, old_keyshare.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
export class Keyshare {
    ...
    keyId() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.keyshare_keyId(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
export class PreSign {
    ...
    toBytes() {
        try {
            const ptr = this.__destroy_into_raw();
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.presign_toBytes(retptr, ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1, 1);
...
export class SignSession {
    ...
    static setup(key_id, chain_path, message, ids) {
        try {
            ...
            wasm.signsession_setup(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
