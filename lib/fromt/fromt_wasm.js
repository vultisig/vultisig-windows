...
export class FromtKeyImageSession {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(FromtKeyImageSession.prototype);
        obj.__wbg_ptr = ptr;
        FromtKeyImageSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FromtKeyImageSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_fromtkeyimagesession_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} msg
     * @returns {boolean}
    ...
    feed(msg) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.fromtkeyimagesession_feed(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {Uint8Array} setup_bytes
     ...
     * @returns {FromtKeyImageSession}
     */
    static fromSetup(setup_bytes, my_party_name, key_share) {
        const ptr0 = passArray8ToWasm0(setup_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(my_party_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(key_share, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.fromtkeyimagesession_fromSetup(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return FromtKeyImageSession.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} msg
     * @param {number} index
    ...
    msgReceiver(msg, index) {
        const ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.fromtkeyimagesession_msgReceiver(this.__wbg_ptr, ptr0, len0, index);
        let v2;
        if (ret[0] !== 0) {
            v2 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    result() {
        const ret = wasm.fromtkeyimagesession_result(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    takeMsg() {
        const ret = wasm.fromtkeyimagesession_takeMsg(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) FromtKeyImageSession.prototype[Symbol.dispose] = FromtKeyImageSession.prototype.free;
...
export class KeyImagePart1Result {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KeyImagePart1Result.prototype);
        obj.__wbg_ptr = ptr;
        KeyImagePart1ResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KeyImagePart1ResultFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_keyimagepart1result_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get handle_id() {
        const ret = wasm.keyimagepart1result_handle_id(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Uint8Array}
     */
    get partials() {
        const ret = wasm.keyimagepart1result_partials(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
}
if (Symbol.dispose) KeyImagePart1Result.prototype[Symbol.dispose] = KeyImagePart1Result.prototype.free;
 ...
 * @returns {Uint8Array}
 */
export function fromtKeyImageSetupMsgNew(parties_data, outputs) {
    const ptr0 = passArray8ToWasm0(parties_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(outputs, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.fromtKeyImageSetupMsgNew(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Uint8Array}
 */
export function fromt_build_signable_tx(key_share, recipient, amount, fee_per_weight, fee_mask, inputs_data, decoys_data) {
 ...
 * @param {Uint8Array} spend_pub_key
 * @param {Uint8Array} tx_pub_key
 * @param {bigint} output_index
 * @param {Uint8Array} output_key
 * @returns {Uint8Array}
 */
export function fromt_check_output(view_secret_key, spend_pub_key, tx_pub_key, output_index, output_key) {
    const ptr0 = passArray8ToWasm0(view_secret_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(spend_pub_key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(tx_pub_key, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArray8ToWasm0(output_key, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_check_output(ptr0, len0, ptr1, len1, ptr2, len2, output_index, ptr3, len3);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v5 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function fromt_derive_commitment_mask(view_secret_key, tx_pub_key, output_index) {
    const ptr0 = passArray8ToWasm0(view_secret_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(tx_pub_key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_derive_commitment_mask(ptr0, len0, ptr1, len1, output_index);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {Uint8Array}
 */
export function fromt_derive_key_offset(view_secret_key, tx_pub_key, output_index) {
    const ptr0 = passArray8ToWasm0(view_secret_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(tx_pub_key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_derive_key_offset(ptr0, len0, ptr1, len1, output_index);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
/**
 * @param {Uint8Array} outputs_data
 * @param {Uint8Array} spent_flags
 * @returns {Uint32Array}
 */
export function fromt_filter_spent_outputs(outputs_data, spent_flags) {
    const ptr0 = passArray8ToWasm0(outputs_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(spent_flags, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_filter_spent_outputs(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @param {Uint8Array} key_share
 * @param {Uint8Array} outputs
 * @param {Uint8Array} signer_ids
 * @returns {KeyImagePart1Result}
 */
export function fromt_key_image_part1(key_share, outputs, signer_ids) {
    const ptr0 = passArray8ToWasm0(key_share, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(outputs, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(signer_ids, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_key_image_part1(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return KeyImagePart1Result.__wrap(ret[0]);
}

/**
 * @param {number} handle_id
 * @param {Uint8Array} r1_packages
 * @returns {Uint8Array}
 */
export function fromt_key_image_part2(handle_id, r1_packages) {
    const ptr0 = passArray8ToWasm0(r1_packages, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_key_image_part2(handle_id, ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function fromt_outputs_for_key_image(outputs_data) {
    const ptr0 = passArray8ToWasm0(outputs_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_outputs_for_key_image(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function fromt_tx_hash(raw_tx) {
    const ptr0 = passArray8ToWasm0(raw_tx, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fromt_tx_hash(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
const FromtKeyImageSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_fromtkeyimagesession_free(ptr >>> 0, 1));
...
const KeyImagePart1ResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_keyimagepart1result_free(ptr >>> 0, 1));
