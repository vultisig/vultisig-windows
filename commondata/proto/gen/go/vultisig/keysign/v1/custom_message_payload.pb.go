...
type CustomMessagePayload struct {
	...
	VaultPublicKeyEcdsa string                 `protobuf:"bytes,3,opt,name=vault_public_key_ecdsa,json=vaultPublicKeyEcdsa,proto3" json:"vault_public_key_ecdsa,omitempty"`
	VaultLocalPartyId   string                 `protobuf:"bytes,4,opt,name=vault_local_party_id,json=vaultLocalPartyId,proto3" json:"vault_local_party_id,omitempty"`
...
func (x *CustomMessagePayload) GetVaultPublicKeyEcdsa() string {
	if x != nil {
...
func (x *CustomMessagePayload) GetVaultLocalPartyId() string {
	if x != nil {
...
const file_vultisig_keysign_v1_custom_message_payload_proto_rawDesc = "" +
	"\n" +
	"0vultisig/keysign/v1/custom_message_payload.proto\x12\x13vultisig.keysign.v1\"\xae\x01\n" +
	"\x14CustomMessagePayload\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x123\n" +
	"\x16vault_public_key_ecdsa\x18\x03 \x01(\tR\x13vaultPublicKeyEcdsa\x12/\n" +
	"\x14vault_local_party_id\x18\x04 \x01(\tR\x11vaultLocalPartyIdBT\n" +
...
var (
	...
	file_vultisig_keysign_v1_custom_message_payload_proto_rawDescData []byte
)
...
func file_vultisig_keysign_v1_custom_message_payload_proto_rawDescGZIP() []byte {
	file_vultisig_keysign_v1_custom_message_payload_proto_rawDescOnce.Do(func() {
		file_vultisig_keysign_v1_custom_message_payload_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vultisig_keysign_v1_custom_message_payload_proto_rawDesc), len(file_vultisig_keysign_v1_custom_message_payload_proto_rawDesc)))
	})
...
func file_vultisig_keysign_v1_custom_message_payload_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vultisig_keysign_v1_custom_message_payload_proto_rawDesc), len(file_vultisig_keysign_v1_custom_message_payload_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
