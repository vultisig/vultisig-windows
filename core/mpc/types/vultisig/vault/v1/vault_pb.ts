...
export const file_vultisig_vault_v1_vault: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp, file_vultisig_keygen_v1_lib_type_message]);
...
export type Vault = Message<"vultisig.vault.v1.Vault"> & {
   ...
   *
   * @generated from field: string public_key_mldsa44 = 12;
   */
  publicKeyMldsa44: string;

  /**
   * @generated from field: string public_key_frozt = 13;
   */
  publicKeyFrozt: string;

  /**
   * @generated from field: string public_key_fromt = 14;
   */
  publicKeyFromt: string;
};
