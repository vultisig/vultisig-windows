...
import { InstallPluginPendingState } from '@core/ui/mpc/keygen/reshare/plugin/InstallPluginPendingState'
import { usePluginInstallAnimation } from '@core/ui/mpc/keygen/reshare/plugin/PluginInstallAnimationProvider'
...
import { ChatPluginReshareServerActionProvider } from './ChatPluginReshareServerActionProvider'

const steps = ['confirmation', 'keygen'] as const
const closePopupDelay = 1200
const appInstallTotalSequenceNo = 12

export const ChatPluginReshareFlowContent = ({
  plugin,
        ...
        to={({ value: { password } }) => (
          <PasswordProvider initialValue={password}>
            <Match
              value={step}
              confirmation={() => (
                <ChatPluginReshareServerActionProvider>
