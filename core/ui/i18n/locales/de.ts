export const de = {
  ...
  vultStaking: {
    stake: 'Einsatz',
    unstake: 'Entkoppeln',
    deposit_header: 'Einzahlung VULT',
    withdraw_header: 'VULT zurückziehen',
    claim: 'Beanspruchen',
    cancel: 'Stornieren',
    cancel_unstake: 'Abbrechen Einsatz aufheben',
    staked: '$VULT gestakt',
    description:
      'Durch das Staking von $VULT erhalten Sie zahlreiche exklusive Vorteile im Vultisig-Ökosystem, wie z. B. Swap-Rabatte, erhöhte Inferenzlimits und vieles mehr, was noch kommen wird.',
    verify_stake: 'Einsatz bestätigen',
    verify_unstake: 'Freigabe bestätigen',
    youre_unstaking: 'Du enthüllst die Einsätze.',
    youre_claiming: 'Du behauptest',
    youre_cancelling: 'Sie stornieren',
    pending_unstakes: 'Auflösen',
    unstaking_amount: 'Unstaking {{amount}}',
    ready_to_claim: 'Bereit zum Beanspruchen',
    unstake_cooldown_term:
      'Das Entstaking löst eine Abklingzeit von {{duration}} aus. Dein VULT kann beansprucht werden, sobald diese abgelaufen ist.',
    unstake_cooldown_term_generic:
      'Ihr Guthaben steht Ihnen nach Ablauf der Einlösungsfrist zur Verfügung.',
  },
