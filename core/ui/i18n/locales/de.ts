export const de = {
  ...
  enable_token_instruction:
    'Aktivieren Sie mindestens ein Token, um Guthaben anzuzeigen und Positionen zu verwalten.',
  optional: 'optional',
  ...
  token_not_found_description:
    'Mögliche Gründe: falscher Vertrag, nicht unterstützte Chain oder Token aus Registern entfernt.',
