export const de = {
  ...
  advanced: 'Erweitert',
  advanced_gas_fee: 'Erweiterte Gasgebühr',
  ...
  balance_changes: 'Guthabenänderungen',
  ...
  circle: {
    ...
    withdraw: 'Abheben',
    withdraw_header: 'Von Circle abheben',
  ...
  manage_referral_title: '{{productName}}-Empfehlungen',
  ...
  tron_ready_to_claim: 'Bereit zum Beanspruchen',
  withdraw_expire_unfreeze: 'Beanspruchen',
  ...
  agent_tx_type_contract_call: 'Vertragsaufruf',
  agent_tx_type_contract_execute: 'Vertragsausführung',
  agent_tx_type_deposit: 'Einzahlung',
  ...
  invalid_validator_address: 'Ungültige Validator-Adresse',
  ...
  source_validator: 'Quell-Validator',
  destination_validator: 'Ziel-Validator',
  redelegate_same_validator:
    'Ziel-Validator muss sich vom Quell-Validator unterscheiden.',
  delegate: 'Delegieren',
  undelegate: 'Undelegate',
  redelegate: 'Neudelegieren',
  claim_rewards: 'Prämien einfordern',
  select_validator: 'Validator auswählen',
  ...
  validator_status_churned_out: 'Ausrotiert',
  move: 'Verschieben',
  validator: 'Validator',
  ...
  you_are_moving: 'Du verschiebst',
  you_are_claiming: 'Du beanspruchst',
  ...
  sui_call_balance_destroy_zero: 'Zerstöre leeres Guthaben',
  sui_call_balance_join: 'Zusammenführungssalden',
  sui_call_balance_split: 'Guthaben aufteilen',
  ...
  sui_call_coin_into_balance: 'Münze in Guthaben auspacken',
  ...
  contract_address_copied: 'Vertragsadresse kopiert',
