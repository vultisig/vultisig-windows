export const hr = {
  ...
  delegate_to_new_validator: 'Delegat novom validatoru',
  ...
  vultStaking: {
    stake: 'Ulog',
    unstake: 'Ukloni',
    deposit_header: 'Uplata putem VULT-a',
    withdraw_header: 'Povlačenje VULT-a',
    claim: 'Zahtjev',
    cancel: 'Otkazati',
    cancel_unstake: 'Otkaži poništavanje',
    staked: 'Uloženo $VULT',
    description:
      'Ulaganje $VULT daje vam više ekskluzivnih pogodnosti u ekosustavu Vultisig, poput popusta na swap, povećanih ograničenja inferencije i još mnogo toga.',
    verify_stake: 'Potvrdi ulog',
    verify_unstake: 'Potvrdi poništavanje',
    youre_unstaking: 'Oduzimaš ulog',
    youre_claiming: 'Tvrdite',
    youre_cancelling: 'Otkazujete',
    pending_unstakes: 'Uklanjanje tragova',
    unstaking_amount: 'Uklanjanje udjela {{amount}}',
    ready_to_claim: 'Spremno za podnošenje zahtjeva',
    unstake_cooldown_term:
      'Uklanjanjem uloga započinje vrijeme hlađenja od {{days}} dana. Vaš VULT možete zatražiti nakon što završi.',
    unstake_cooldown_term_generic:
      'Vaša sredstva bit će dostupna za preuzimanje nakon završetka razdoblja otkupa.',
  },
}
