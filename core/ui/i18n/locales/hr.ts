export const hr = {
  ...
  find_custom_token: 'Pronađi prilagođeni token',
  ...
  installing_plugin: 'Instaliranje dodatka',
  plugin_info: 'Informacije o dodatku',
  plugin_info_desc: 'Instalirate dodatak {{name}}',
  plugin_success_desc: 'Instalacija {{name}} je završena',
  plugin_password_desc:
    'Unesite svoju lozinku za otključavanje dijeljenog poslužitelja i početak instalacije dodatka',
  plugin_policy: 'Pregled pravila',
  plugin_policy_desc:
    'Verifikator će uvijek provjeravati izvršavaju li se samo ove politike. To vam daje sigurnost da će samo ovlašteni biti potpisani.',
  plugin_policy_heading: 'Ovaj dodatak će automatski pristupiti',
