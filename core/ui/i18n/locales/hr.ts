export const hr = {
  ...
  secure_vault_setup_title: 'Végső Biztonság',
  secure_vault_setup_prop_0: 'Maximális biztonság több eszközzel',
  secure_vault_setup_prop_1: 'Mindig elérhető eszközmentésekkel',
  secure_vault_setup_prop_2: 'Bármennyi eszköz biztonságba helyezése',
  ...
  fast_vault_setup_prop_0: 'Csak 1 eszköz szükséges',
  fast_vault_setup_prop_1: 'Kisebb összegek tárolása napi használatra',
  fast_vault_setup_prop_2: 'A Vultiserver azonnal aláír',
  ...
  swap_terms_1: 'Slažem se s minimalnim iznosom koji ću primiti',
