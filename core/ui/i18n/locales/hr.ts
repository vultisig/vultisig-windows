export const hr = {
  ...
  chart_range_week: '1W',
  chart_range_year: '1Y',
  circulating_supply: 'Ponuda u optjecaju',
  contract_address_copied: 'Adresa ugovora kopirana',
  decimals: 'Decimale',
  fully_diluted_valuation: 'Potpuno razrijeđena procjena',
  high_24h: '24h najviše',
  low_24h: '24h najniže',
  market_cap: 'Tržišna kapitalizacija',
  market_cap_rank: 'Rang',
  market_stats: 'Tržišna statistika',
