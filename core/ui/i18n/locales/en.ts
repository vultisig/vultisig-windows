export const en = {
  ...
  buy_vult_banner_title: 'And save on swap fees',
  buy_vult_banner_caption: 'Buy $VULT',
  follow_banner_caption: 'Vultisig is building with you',
  ...
  swap_limit_filled_so_far: 'Filled so far',
  swap_limit_minimum_received: 'Minimum received',
  swap_limit_no_orders: 'No limit orders yet',
  swap_limit_order_status: 'Order status',
  swap_limit_done_hint:
    'Track them in Transaction History under the Limit Orders tab.',
  swap_limit_progress_filled: '{{percent}}% filled',
  ...
  kamino_earn_entire_position: 'Everything in this vault',
  kamino_earn_strands_wrapped_sol_rent:
    'This deposit opens a wrapped SOL account, which holds a small amount of SOL until you withdraw.',
  ...
  kamino_earn_card_deposit: 'Deposit',
  ...
  signed_awaiting_broadcast: 'Signed, awaiting broadcast',
  signed_awaiting_broadcast_description:
    'This transaction was signed and handed back to the dApp that requested it. Sending it to the network is up to the dApp; the status updates once the network sees it.',
}
