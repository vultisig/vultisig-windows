export const en = {
  ...
  available_nodes_coming_soon: 'Available nodes coming soon',
  ...
  choose_payout_asset: 'Select Payout Asset',
  choose_tokens: 'Select Tokens',
  choose_vault: 'Select Vault',
  circle: {
    apy: 'APY',
  ...
  failed_to_load_bonded_nodes: 'Failed to load bonded nodes.',
  failed_to_load_lp_positions: 'Failed to load LP positions.',
  failed_to_load_stake_data: 'Failed to load stake data.',
  ...
  no_lp_positions_found: 'No LP positions found for this address.',
  ...
  total_bonded_rune: 'Total Bonded RUNE',
  ...
  wait_until_node_churned_out: 'Wait until Node is churned out',
  wallet: 'Wallet',
