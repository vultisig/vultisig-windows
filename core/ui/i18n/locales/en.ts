export const en = {
  ...
  chain_sync_chain_tip: 'Chain Tip',
  chain_sync_scan_progress: 'Scan Progress',
  chain_sync_scanned_height: 'Scanned Height',
  chain_sync_wallet_birthday: 'Wallet Birthday Height',
  ...
  finalise: 'Finalise',
  finalise_balance_scan: 'Balance Scan',
  ...
  hold_for_paired_reveal: 'Hold for paired reveal',
  ...
  outputs_checked: 'Outputs Not Checked',
  outputs_found: 'Outputs Found',
  total_outputs: 'Total Outputs',
  positions: 'Positions',
  powered_by: 'Powered by <provider></provider>',
  prepareVault: 'Preparing vault...',
  price: 'Price',
  current_scanned_balance: 'Current Scanned Balance',
  unknown_outputs: 'Unknown Outputs',
  ...
  revealing_outputs: 'Revealing Outputs',
  silver: 'Silver',
  site: 'Site',
  ...
  agent_connect_description:
    'Enter your vault password to connect to the agent. Your password is used to sign an authentication message.',
  agent_connect_now: 'Connect now',
  ...
  agent_tx_view: 'View',
  balance_scan_finalised: 'Balance scan finalised',
  monero_scan_progress: 'Scan Progress',
  monero_balance_finalise_fast_unavailable:
    'Fast Sign is not available for Monero balance finalisation yet.',
  monero_balance_scan_finalised_description: 'The view-only scan is complete.',
  monero_balance_scan_not_ready:
    'Balance finalisation is only available once scanning is complete.',
  monero_balance_scan_ready_description:
    'Review the scanned outputs and sign to remove spent outputs from the balance.',
  monero_balance_scan_syncing_description:
    'The view-only scan is still syncing to the latest safe height.',
  monero_balance_scan_syncing_progress:
    'Scanning block {{current}} of {{target}}.',
  monero_balance_scan_syncing_outputs:
    'The scan is still running. Outputs and balance will appear as they are found.',
  monero_blocks_to_go: 'Blocks To Go',
  monero_confirming_description:
    'Change outputs are confirming. Sending will be available after {{count}} more blocks.',
  confirming: 'Confirming',
  send_disabled_confirming: '{{count}} conf. left',
  ...
  zcash_balance_scan_syncing_description:
    'The shielded scan is still syncing to the latest safe height.',
