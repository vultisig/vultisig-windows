export const en = {
  ...
  agent_action_approved: 'Approved',
  agent_action_changes_requested: 'Changes requested',
  agent_action_rejected: 'Rejected',
  agent_chat_render_error: 'Something went wrong rendering the chat.',
  agent_connect_description:
    'Sign in to enable agent features like swaps and signing.',
  agent_connect_now: 'Connect Now',
  agent_connected: 'Connected',
  agent_connecting: 'Connecting...',
  agent_operation_sign_in: 'Sign In',
  agent_session_expired: 'Your session has expired. Please sign in again.',
  agent_sign_in_failed: 'Sign in failed. Please try again.',
  agent_signing_in: 'Signing in...',
  agent_request_changes: 'Request Changes',
  agent_request_changes_placeholder: 'Describe what should change...',
  agent_submit_feedback: 'Submit Feedback',
  ...
  agent_tx_view: 'View',
  dont_ask_approval_this_session: "Don't ask for approval this session",
  review_transactions: 'Review Transactions',
  token_results: 'Token Results',
  action: 'Action',
  active: 'Active',
  ...
  adding_to_vault: 'Adding...',
  failed_to_add_token: 'Failed to add token',
  no_deployments: 'No deployments available',
  transaction_n_of_total: 'Transaction {{n}} of {{total}}',
}
