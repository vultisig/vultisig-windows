export const ru = {
  ...
  select_delegation: 'Избрать делегацию',
  ...
  source_validator: 'Валидатор исходного кода',
  destination_validator: 'Валидатор пункта назначения',
  redelegate_same_validator:
    'Валидатор назначения должен отличаться от валидатора источника.',
  delegate: 'Делегат',
  undelegate: 'Отстранить',
  redelegate: 'Переизбрание',
  claim_rewards: 'Получите вознаграждение',
  select_validator: 'Выберите валидатор',
  ...
  staked_label: 'Застейка: {{amount}} {{ticker}}',
  unbonding_lock_label: '{{days}}-day блокировка разъединения',
  unbonding_unlocks_at: 'Разблокирует {{date}}',
  validator_status_active: 'Активный',
  validator_status_churned_out: 'Произведено в готовом виде',
  validator_voting_power: '{{amount}} {{ticker}}',
  validator_commission: '{{rate}}%',
  move: 'Двигаться',
  validator: 'Валидатор',
  pending_rewards: 'Ожидаются награды',
  ...
  you_are_moving: 'Вы переезжаете',
  you_are_claiming: 'Вы утверждаете',
  commission: 'комиссия',
  claim_n_validators: 'Запрос от валидаторов {{count}}',
}
