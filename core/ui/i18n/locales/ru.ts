export const ru = {
  ...
  enable_ton_w5_wallet_description:
    'Создавайте учетные записи TON с помощью контракта W5 (v5r1) вместо V4R2. Каждый контракт представляет собой отдельный адрес со своим собственным балансом; существующие монеты TON перемещаются на выбранную учетную запись.',
}
