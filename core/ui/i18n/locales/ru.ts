export const ru = {
  ...
  swap_all_providers_failed:
    'Сервисы обмена временно недоступны. Пожалуйста, попробуйте еще раз через некоторое время.',
  swap_amount_below_minimum:
    'Увеличьте сумму до минимального размера свопа, установленного поставщиком услуг.',
  swap_amount_too_small:
    'Введите большую сумму, чтобы получить предложение по обмену.',
  swap_invalid_config:
    'Проверьте детали обмена, получателя и расширенные настройки, затем попробуйте снова.',
  swap_no_routes_found: 'Для данной пары активов своп-опционы недоступны.',
