export const ru = {
  ...
  follow_banner_caption: 'Vultisig строит вместе с вами.',
  follow_banner_title: 'Подписывайтесь на нас в X',
  rujira_banner_caption: 'Stake & earn',
  rujira_banner_title: 'Rujira staking live now',
  vault_backup_banner_caption: 'Back Up Your Vault',
  vault_backup_banner_title: 'Request full vault custody',
  referral_banner_caption: 'Don’t miss rewards',
  referral_banner_title: 'Add your referral code',
  kamino_banner_caption: 'New on Solana',
  kamino_banner_title: 'Start earning with Kamino',
  from: 'От',
  freeze: 'Freeze',
