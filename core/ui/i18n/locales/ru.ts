export const ru = {
  ...
  rujira_banner_subtitle: 'Stake & earn',
  rujira_banner_title: 'Rujira staking live now',
  vault_backup_banner_subtitle: 'Back Up Your Vault',
  vault_backup_banner_title: 'Request full vault custody',
  referral_banner_subtitle: 'Don’t miss rewards',
  referral_banner_title: 'Add your referral code',
  kamino_banner_subtitle: 'New on Solana',
