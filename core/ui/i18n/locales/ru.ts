export const ru = {
  ...
  solana_staking_move_notice:
    'Перемещение стейка — это многоэтапный процесс, охватывающий несколько эпох: сейчас это деактивирует аккаунт; после истечения ~ {{days}} -дневного периода ожидания завершите перемещение стейка к выбранному вами валидатору.',
  ...
  solana_staking_pending_move_notice:
    'Перемещение к {{validator}} — завершите перемещение после окончания времени перезарядки.',
}
