export const ru = {
  ...
  enable_ton_w5_wallet_description:
    'Создавайте учетные записи TON с контрактом W5 (v5r1) вместо V4R2. Это изменит адрес, используемый кошельком, и каждый контракт будет представлять собой отдельный адрес со своим собственным балансом — средства на нем не перемещаются, поэтому все, что хранится на другом адресе, остается там до тех пор, пока вы его не отправите.',
}
