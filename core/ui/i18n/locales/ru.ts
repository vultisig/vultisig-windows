export const ru = {
  ...
  sui_call_coin_into_balance: 'Распакуйте монету, чтобы сбалансировать баланс.',
  sui_call_coin_join: 'Монеты слияния',
  ...
  vultStaking: {
    stake: 'Ставка',
    unstake: 'Вывести средства',
    deposit_header: 'Вклад VULT',
    withdraw_header: 'Вывести VULT',
    claim: 'Требовать',
    cancel: 'Отмена',
    cancel_unstake: 'Отменить вывод средств',
    staked: '$VULT в стейкинге',
    description:
      'Стейкинг $VULT предоставляет вам множество эксклюзивных преимуществ в экосистеме Vultisig, таких как скидки на обмен, увеличенные лимиты вывода и многое другое в будущем.',
    verify_stake: 'Подтвердить ставку',
    verify_unstake: 'Подтвердить вывод средств',
    youre_unstaking: 'Вы выводите средства из стейкинга',
    youre_claiming: 'Вы утверждаете',
    youre_cancelling: 'Вы отменяете бронирование.',
    pending_unstakes: 'Вывод средств из стейкинга',
    unstaking_amount: 'Вывод токенов из стейкинга {{amount}}',
    ready_to_claim: 'Готов подать заявку',
    unstake_cooldown_term:
      'Отмена стейкинга запускает период ожидания {{days}} дней. Ваши VULT можно будет забрать после его окончания.',
    unstake_cooldown_term_generic:
      'Ваши средства станут доступны для получения после окончания периода погашения.',
  },
}
