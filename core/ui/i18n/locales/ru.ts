export const ru = {
  ...
  onboarding_step_1:
    'Скажите «привет» <g>долям хранилища,</g> вашему новому <g>методу восстановления</g>',
  onboarding_step_2:
    'Они <g>разделены на части</g>, чтобы повысить безопасность и <g>убрать единую точку отказа</g>',
  onboarding_step_3:
    '<g>Каждое устройство</g> в хранилище хранит <g>одну долю</g>',
  onboarding_step_4:
    'Восстановите хранилище даже <g>если устройство потеряно или повреждено</g>',
  onboarding_step_5:
    '<g>Всегда делайте резервную копию каждой доли</g> отдельно и <g>в разных местах</g>',
  onboarding_step_6: 'Эти доли совместно <g>разблокируют ваше хранилище</g>',
