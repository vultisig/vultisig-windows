export const ru = {
  ...
  swap_failed_refunded_description:
    'Обмен не удалось завершить, поэтому провайдер отправил ваши средства обратно на ваш кошелек вместо запрошенного вами актива. Ничего не было обменяно. Попробуйте еще раз, чтобы получить новое предложение.',
}
