export const ru = {
  ...
  ripple_warning_partial_payment:
    'Данная транзакция представляет собой частичную оплату: указанная сумма является максимальной, а не гарантированной. Получатель может получить меньшую сумму, в то время как вы все равно оплатите указанную максимальную сумму.',
  ripple_warning_custom_paths:
    'Сайт сам выбрал маршрут, по которому будет осуществляться этот платеж через сеть.',
}
