export const ru = {
  ...
  backupsDescription:
    'Резервные копии обеспечивают работу вашего хранилища. Каждое устройство имеет свои особенности.<w> собственный</w> Резервное копирование. Одной резервной копии недостаточно для перемещения средств, она нужна только для восстановления. Импортируйте и восстановите данные с любого потерянного устройства.',
  backupEachDevice: 'Создайте резервные копии каждого устройства.',
  backupEachDeviceDescription:
    'Пароли резервных копий устройства <w> и </w> являются ключами. Сервер лишь осуществляет совместную подпись, и можно запросить резервную копию.',
  ...
  connect_dapp: 'Подключить децентрализованное приложение',
  ...
  qbtc_claim_broadcasting: 'Заявление о вещании…',
  qbtc_claim_success_title: 'Заявка успешно подана',
  qbtc_claim_utxos_claimed: 'УТХО были заявлены',
  ...
  forward_ton_amount: 'Форвардный тонновый объем',
