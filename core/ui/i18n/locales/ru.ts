export const ru = {
  ...
  tron_bandwidth_description:
    'Очки пропускной способности необходимы для каждой транзакции в сети TRON, включая как стандартную отправку токенов, так и взаимодействие со смарт-контрактами. Каждый пользователь TRON ежедневно получает 600 бесплатных очков пропускной способности, которых хватает примерно на две базовые отправки. Кроме того, вы можете получить дополнительные очки пропускной способности, застейкав TRX, увеличивая свой ежедневный баланс для поддержки большего числа транзакций. Если у вас достаточно очков пропускной способности, вы можете отправлять токены, стейкать TRX или взаимодействовать со смарт-контрактами, не платя TRX в виде комиссии за gas.',
