export const ru = {
  ...
  ton_tx_failure_action_failed:
    'Кошелек принял транзакцию, но не смог осуществить перевод, поэтому ничего не было отправлено. Комиссия сети всё равно была списана. Проверьте баланс и попробуйте снова.',
