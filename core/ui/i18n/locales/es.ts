export const es = {
  ...
  vultStaking: {
    stake: 'Apostar',
    unstake: 'Deshacer la apuesta',
    deposit_header: 'Depósito VULT',
    withdraw_header: 'Retirar VULT',
    claim: 'Afirmar',
    cancel: 'Cancelar',
    cancel_unstake: 'Cancelar Desvincular',
    staked: '$VULT apostado',
    description:
      'Al hacer staking de $VULT, obtendrá múltiples beneficios exclusivos en el ecosistema Vultisig, como descuentos en swaps, límites de inferencia aumentados y mucho más por venir.',
    verify_stake: 'Verificar participación',
    verify_unstake: 'Verificar Desvincularse',
    youre_unstaking: 'Estás deshaciendo la apuesta.',
    youre_claiming: 'Estás afirmando',
    youre_cancelling: 'Estás cancelando',
    pending_unstakes: 'Desvinculación',
    unstaking_amount: 'Desactivando el token {{amount}}',
    ready_to_claim: 'Listo para reclamar',
    unstake_cooldown_term:
      'Al retirar el staking, se inicia un período de espera de X días ({{days}}). Podrá reclamar su VULT una vez que finalice dicho período.',
    unstake_cooldown_term_generic:
      'Podrá reclamar sus fondos una vez finalizado el período de reembolso.',
  },
}
