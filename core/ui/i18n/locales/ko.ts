export const ko = {
  ...
  suggest_chain_subtitle: '{{site}}님이 이 체인을 지갑에 추가하려고 합니다.',
  suggest_chain_title: '추천 체인 추가',
  balance_changes: '잔액 변동',
  connect_dapp: 'dApp에 연결하세요',
  connect_website_subtitle: '이 웹사이트를 Vultisig Extension에 연결하세요.',
  banner_carousel_go_to_banner: '배너 {{number}}로 이동',
