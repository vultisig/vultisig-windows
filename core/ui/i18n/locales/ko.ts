export const ko = {
  ...
  vultStaking: {
    stake: '말뚝',
    unstake: '언스테이킹',
    deposit_header: 'VULT 예치',
    withdraw_header: 'VULT를 인출하세요',
    claim: '주장하다',
    cancel: '취소',
    cancel_unstake: '취소 스테이킹 해제',
    staked: '$VULT 스테이킹됨',
    description:
      '$VULT를 스테이킹하면 스왑 할인, 추론 한도 증가 등 Vultisig 생태계에서 누릴 수 있는 다양한 독점 혜택을 얻을 수 있으며, 앞으로 더 많은 혜택이 제공될 예정입니다.',
    verify_stake: '지분 검증',
    verify_unstake: '스테이킹 해제 검증',
    youre_unstaking: '당신은 말뚝을 뽑고 있습니다',
    youre_claiming: '당신은 주장하고 있습니다',
    youre_cancelling: '취소하시려고 합니다',
    pending_unstakes: '언스테이킹',
    unstaking_amount: '{{amount}} 언스테이킹',
    ready_to_claim: '수령 준비 완료',
    unstake_cooldown_term:
      '스테이킹 해제 시 {{days}}일의 쿨다운이 시작됩니다. 쿨다운이 끝나면 VULT를 수령하실 수 있습니다.',
    unstake_cooldown_term_generic:
      '상환 기간이 종료되면 자금을 수령하실 수 있습니다.',
  },
}
