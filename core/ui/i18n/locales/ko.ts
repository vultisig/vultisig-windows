export const ko = {
  ...
  choose_chains: '체인을 선택하세요',
  choose_tokens: '토큰을 선택하세요',
  choose_vaults: '금고를 선택하세요',
  deposited: '예치됨',
  circle: {
    banner_text:
      '자금은 전적으로 귀하의 금고 관리 하에 있습니다. Circle 계정은 자체 관리형이며 수익은 안전한 오프체인 재무부를 통해 발생합니다.',
    open_account: '계좌 개설',
    withdraw: '출금',
    withdraw_header: 'Circle에서 출금',
  ...
  adding_coin_to_vault: '금고에 코인을 추가하는 중...',
  ...
  buy_vult_banner_caption: '$VULT를 매수하세요',
  follow_banner_caption: 'Vultisig는 여러분과 함께 만들어갑니다.',
  ...
  no_positions_found: '포지션을 찾을 수 없습니다.',
  ...
  wait_until_node_churned: '노드가 교체될 때까지 기다리세요',
  ...
  save: '저장',
  save_10_percent_on_swaps: '지금 스왑에서 <blue>10%</blue> 절약하세요',
  ...
  save_swap_fees_with_referral:
    '스왑 거래 시 <blue>10%</blue> 절약 - 추천인 추가',
  saving_vault: '금고를 저장하는 중...',
  ...
  select_chains: '체인을 선택하세요',
  select_chains_manually: '체인을 수동으로 선택하세요',
  select_positions: '포지션을 선택하세요',
  ...
  vault_backup_page_submit_loading_button_text: '저장 중...',
  ...
  yesterday: '어제',
  you_are_bonding: '본딩하고 있습니다',
  you_are_unbonding: '당신은 연결을 끊고 있습니다',
  you_are_sending: '보내는 중입니다',
  you_are_staking: '당신은 스테이킹을 하고 있어요',
  you_are_unstaking: '언스테이킹하고 있습니다',
  you_are_moving: '이동하고 있습니다',
  you_are_claiming: '청구하고 있습니다',
  commission: '수수료',
  ...
  qbtc_claim_count: '{{total}}개 중 {{count}}개 청구',
  raw_message: '원본 메시지',
  token: '토큰',
  ...
  station_migration_source_mnemonic: '니모닉',
  ...
  sui_call_coin_into_balance: '코인을 잔액으로 변환',
  ...
  qbtc_gov: {
    ...
    option: {
      ...
      abstain: '기권',
      no: '아니요',
      noWithVeto: '거부권 행사 불가',
    },
    proposal_number: '제안 번호 # {{id}}',
    ...
    ends_in_days_hours: '{{days}} d {{hours}} h로 끝납니다.',
    ends_in_hours_minutes: '{{hours}} h {{minutes}} m로 끝납니다.',
    ends_in_minutes: '{{minutes}} m로 끝납니다.',
    ...
    enable_qbtc_to_vote: '투표하려면 이 볼트에서 QBTC 활성화하세요.',
  },
  ...
  contract_address_copied: '컨트랙트 주소가 복사되었습니다',
  decimals: '소수점 자릿수',
  fully_diluted_valuation: '완전 희석 가치',
  high_24h: '24시간 최고가',
  low_24h: '24시간 최저가',
  market_cap: '시가총액',
  market_cap_rank: '순위',
