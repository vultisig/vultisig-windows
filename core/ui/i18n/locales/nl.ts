export const nl = {
  ...
  use_external_recipient: 'Gebruik externe ontvanger',
  vultStaking: {
    stake: 'Inzet',
    unstake: 'Ontkoppelen',
    deposit_header: 'Stort VULT',
    withdraw_header: 'Trek VULT terug',
    claim: 'Claim',
    cancel: 'Annuleren',
    cancel_unstake: 'Annuleer Unstake',
    staked: '$VULT gestaked',
    description:
      'Door $VULT te staken, profiteert u van diverse exclusieve voordelen binnen het Vultisig-ecosysteem, zoals kortingen op swaps, verhoogde inferentielimieten en nog veel meer.',
    verify_stake: 'Verifieer de inzet',
    verify_unstake: 'Verifiëren Unstake',
    youre_unstaking: 'Je haalt de staking eruit.',
    youre_claiming: 'Je beweert',
    youre_cancelling: 'Je annuleert',
    pending_unstakes: 'Ontstaking',
    unstaking_amount: 'Unstaking {{amount}}',
    ready_to_claim: 'Klaar om te claimen',
    unstake_cooldown_term:
      'Het ontstaken van je VULT start een afkoelperiode van {{days}} dagen. Je VULT kan worden opgeëist zodra deze periode is afgelopen.',
    unstake_cooldown_term_generic:
      'Uw tegoed is beschikbaar voor opname zodra de inwisselperiode is afgelopen.',
  },
}
