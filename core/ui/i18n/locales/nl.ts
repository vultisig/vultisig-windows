export const nl = {
  ...
  having_trouble_scanning_tip_1: 'Beweeg de telefoon iets dichter bij of verder van het scherm',
  having_trouble_scanning_tip_2: 'Zorg ervoor dat het scherm goed verlicht en vrij van schittering is',
