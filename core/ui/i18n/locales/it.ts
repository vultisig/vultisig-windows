export const it = {
  ...
  kamino_earn_entire_position: "L'intera posizione",
  kamino_earn_strands_wrapped_sol_rent:
    'Questo deposito apre un conto SOL vincolato. Il relativo reddito rimane bloccato fino al momento del prelievo.',
