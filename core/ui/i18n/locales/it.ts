export const it = {
  ...
  suggest_chain_subtitle:
    '{{site}} vuole aggiungere questa catena al tuo portafoglio',
  ...
  connect_website_subtitle:
    'Collega questo sito web all&#39;estensione Vultisig',
  ...
  qbtc_claim_selected_count: '{{count}} di {{max}} selezionati',
  ...
  verify_password_for: 'Verifica la tua password per:',
