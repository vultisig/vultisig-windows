export const it = {
  ...
  select_delegation_to_move: 'Seleziona il delegato per spostarti',
  ...
  delegate: 'Delegare',
  undelegate: 'Non delegato',
  redelegate: 'Rieleggere',
  ...
  you_are_moving: 'Ti stai muovendo',
  ...
  sui_param_balance: 'bilancia',
  sui_param_coin: 'coniare',
  ...
  vultStaking: {
    stake: 'Palo',
    unstake: 'Sbloccare',
    deposit_header: 'Deposito VULT',
    withdraw_header: 'Ritirare VULT',
    claim: 'Reclamo',
    cancel: 'Cancellare',
    cancel_unstake: 'Annulla Rimuovi puntata',
    staked: '$VULT messo in staking',
    description:
      'Mettere in staking $VULT ti offre numerosi vantaggi esclusivi nell&#39;ecosistema Vultisig, come sconti sugli swap, limiti di inferenza più elevati e molto altro ancora in arrivo.',
    verify_stake: 'Verifica la partecipazione',
    verify_unstake: 'Verifica Sblocca',
    youre_unstaking: 'Stai rimuovendo il supporto',
    youre_claiming: 'Stai affermando',
    youre_cancelling: 'Stai annullando',
    pending_unstakes: 'Smontare',
    unstaking_amount: 'Sbloccare {{amount}}',
    ready_to_claim: 'Pronto a reclamare',
    unstake_cooldown_term:
      'La disattivazione del token avvia un cooldown {{duration}}. Il tuo VULT potrà essere riscosso al termine del cooldown.',
    unstake_cooldown_term_generic:
      'I fondi saranno disponibili per il riscatto al termine del periodo previsto.',
  },
  advanced_description:
    'Ricondividi, gestisci la sicurezza o firma i messaggi.',
  coming_soon: 'Prossimamente',
  custom_rpc: 'RPC personalizzati',
  custom_rpc_chip_custom: 'Costume',
