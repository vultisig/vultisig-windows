export const it = {
  ...
  wait_until_node_churned: 'Attendi fino alla rotazione del nodo',
  ...
  enable_positions_hint:
    'Abilita le posizioni per visualizzare i saldi e gestire le azioni.',
  compounded_token: '{{ticker}} capitalizzato',
