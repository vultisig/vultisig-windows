export const it = {
  ...
  vultStaking: {
    ...
    youre_unstaking: 'Stai rimuovendo i pali',
    youre_claiming: 'Stai affermando',
    youre_cancelling: 'Stai annullando',
    pending_unstakes: 'Sbloccare',
    unstaking_amount: 'Sbloccare {{amount}}',
    ready_to_claim: 'Pronto a reclamare',
    unstake_cooldown_term:
      'La disattivazione del token avvia un periodo di ricarica di {{days}} giorni. Il tuo VULT potrà essere riscattato al termine di tale periodo.',
