export const pt = {
  ...
  enable_token_instruction:
    'Ative pelo menos um token para visualizar saldos e gerenciar posições.',
  optional: 'opcional',
  ...
  register_your_vaults: 'Registe os seus cofres!',
  ...
  failed_to_connect_with_server: 'Falha ao conectar com o servidor',
  ...
  token_not_found_description:
    'Possíveis razões: contrato incorreto, cadeia não suportada ou token removido dos registros.',
