export const pt = {
  ...
  amount_to_unstake: 'Valor a retirar do staking',
  ...
  balance_changes: 'Alterações de saldo',
  base_fee: 'Taxa base',
  ...
  buy_vult_banner_caption: 'Compre $VULT',
  follow_banner_caption: 'Vultisig está construindo com você.',
  ...
  validator_status_churned_out: 'Rotacionado',
  move: 'Mover',
  validator: 'Validador',
  ...
  you_are_claiming: 'Você está reivindicando',
  commission: 'comissão',
  claim_n_validators: 'Resgatar de {{count}} validadores',
  ...
  sui_call_balance_destroy_zero: 'Destruir saldo vazio',
  ...
  sui_call_coin_into_balance: 'Desembrulhe a moeda para saldo.',
  ...
  ripple_transaction_summary: 'Resumo da transação',
  ...
  ripple_field_send_max: 'Pague no máximo',
  ripple_field_deliver_min: 'Receba pelo menos',
  ripple_field_taker_gets: 'Vendendo',
  ripple_field_taker_pays: 'Comprando',
