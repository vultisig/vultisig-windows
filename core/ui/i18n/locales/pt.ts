export const pt = {
  ...
  security_warning_transaction: 'Aviso de segurança - Transação suspeita',
  malicious_transaction_warning:
    'Esta transação foi sinalizada como maliciosa. Prosseguir pode resultar em perda de fundos.',
