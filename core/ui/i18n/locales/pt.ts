export const pt = {
  ...
  vultStaking: {
    stake: 'Estaca',
    unstake: 'Desvincule',
    deposit_header: 'Depósito VULT',
    withdraw_header: 'Retirar VULT',
    claim: 'Alegar',
    cancel: 'Cancelar',
    cancel_unstake: 'Cancelar Desfazer a participação',
    staked: '$VULT em staking',
    description:
      'Ao fazer staking de $VULT, você obtém diversos benefícios exclusivos no ecossistema Vultisig, como descontos em swaps, limites de inferência aumentados e muito mais por vir.',
    verify_stake: 'Verificar participação',
    verify_unstake: 'Verificar Desvinculação',
    youre_unstaking: 'Você está desfazendo a aposta.',
    youre_claiming: 'Você está alegando',
    youre_cancelling: 'Você está cancelando',
    pending_unstakes: 'Desinvestimento',
    unstaking_amount: 'Desinvestimento de {{amount}}',
    ready_to_claim: 'Pronto para reivindicar',
    unstake_cooldown_term:
      'Ao remover o token de staking, inicia-se um período de espera de {{days}} dias. Seu VULT poderá ser reivindicado assim que esse período terminar.',
    unstake_cooldown_term_generic:
      'Seus fundos estarão disponíveis para resgate assim que o período estipulado terminar.',
  },
}
