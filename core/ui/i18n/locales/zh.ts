export const zh = {
  ...
  coming_soon: '即将推出',
  custom_rpc: '自定义 RPC',
  custom_rpc_chip_custom: '风俗',
  custom_rpc_chip_default: '默认',
  ...
  send_to_different_address: '寄送到其他地址',
  slippage_custom: '风俗',
  ...
  vultStaking: {
    stake: '赌注',
    unstake: '取消抵押',
    deposit_header: '存款 VULT',
    withdraw_header: '撤回 VULT',
    claim: '宣称',
    cancel: '取消',
    cancel_unstake: '取消抵押',
    staked: '$VULT 已质押',
    description:
      '质押 $VULT 可让您在 Vultisig 生态系统中获得多项专属权益，例如兑换折扣、更高的推理限额以及更多即将推出的权益。',
    verify_stake: '验证权益',
    verify_unstake: '验证取消质押',
    youre_unstaking: '你正在取消抵押品',
    youre_claiming: '你声称',
    youre_cancelling: '您正在取消',
    pending_unstakes: '取消抵押',
    unstaking_amount: '取消质押 {{amount}}',
    ready_to_claim: '准备领取',
    unstake_cooldown_term:
      '取消质押后，您的 VULT 将进入 {{days}} 天的冷却期。冷却期结束后，您即可领取您的 VULT。',
    unstake_cooldown_term_generic: '您的资金将在赎回期结束后即可领取。',
  },
}
