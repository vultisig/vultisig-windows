export const zh = {
  ...
  custom_rpc_save_button: '保存 RPC',
  custom_rpc_saved: 'RPC 设置已保存',
  ...
  qbtc_gov: {
    ...
    your_vote: '你的投票',
    confirm_vote: '确认投票',
    enable_qbtc_to_vote: '启用此保险库中的 QBTC 进行投票。',
    ends_in_days_hours: '剩余 {{days}}d {{hours}}h',
