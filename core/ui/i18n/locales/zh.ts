export const zh = {
  ...
  backupsDescription:
    '您的金库并非使用单一助记词，而是由多个设备共同保护。每个设备都有自己的备份。单独的备份无法转移资金，仅用于恢复。',
  backupEachDevice: '备份每个设备',
  backupEachDeviceDescription:
    '这只是您保险库的 1 个备份，请对其他设备重复此过程。',
  ...
  banner_carousel_go_to_banner: '前往横幅广告 {{number}}',
  ...
  nft_transfer: 'NFT转移',
  excess_gas_refund: '多余燃气退款',
  forward_ton_amount: '正向吨位',
  raw_payload: '原始有效载荷',
  spender: '斯潘德',
  operator: '操作员',
  contract: '合同',
