export const zh = {
  ...
  backupGuide: '备份指南',
  backupVault: '备份库',
  backupInCloudTitle: '使用您的保险库密码加密',
  ...
  backupShareWarning: '这只是您金库的一份份额。',
  backupShareWarningRest: '对其他设备重复此过程。',
  ...
  node_address: '节点地址',
  normal: '普通的',
  not_enough_asset_to_cover_gas_fees: '{{asset}} 不足，无法支付 gas 费用',
  ...
  qbtc_claim_tx_hash: '交易哈希',
  qbtc_claim_copy_tx_hash: '复制交易哈希',
  qbtc_claim_done: '完毕',
  ...
  lp_dust_amount_error:
    '符文余额不足。至少需要{{amount}}个符文才能将LP兑换成尘埃。',
  lp_withdraw_percentage: '提款比例',
  ...
  vultibot_description:
    '您的AI金库助手。我可以帮您兑换、发送、自动执行保单、查询余额并管理您的金库。',
  ...
  api_key_required_description:
    '要使用 VultiBot，请在启动应用程序之前将您的 Anthropic API 密钥设置为环境变量。',
  type_a_message: '输入消息……',
  thinking: '思维',
  try_saying: '试着说',
  ...
  agent_connect_description:
    '请输入您的保险库密码以连接到代理。您的密码将用于签署身份验证消息。',
  agent_connect_now: '立即连接',
  agent_connected: '已连接',
  agent_connecting: '正在连接...',
  ...
  no_active_delegations: '没有活跃的代表团',
  you_are_moving: '你要搬家了',
  ...
  qbtc_claim_success_title: '申领成功',
  qbtc_claim_utxos_claimed: 'UTXO 已申领',
  qbtc_claim_utxos_skipped: 'UTXO 已跳过',
  qbtc_claim_tx_hash: '交易哈希',
  qbtc_claim_copy_tx_hash: '复制交易哈希',
  qbtc_claim_done: '完毕',
  qbtc_claim_failed: '申领失败，请重试。',
  ...
  sign_custom_message_unavailable_imported_no_ethereum:
    '此 Vault 导入时未包含 Ethereum。自定义消息签名需要 Ethereum，且导入的 Vault 无法添加导入时遗漏的链。',
