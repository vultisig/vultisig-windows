export const zh = {
  ...
  buy_vult_banner_title: '还能节省掉期费用',
  buy_vult_banner_caption: '购买$VULT',
  follow_banner_caption: 'Vultisig正在与您一起构建',
  follow_banner_title: '请在 X 上关注我们',
  rujira_banner_caption: '参与并赢取奖励',
  rujira_banner_title: 'Rujira 质押现已上线',
  vault_backup_banner_caption: '备份您的保险库',
  vault_backup_banner_title: '请求全额保管金库',
  referral_banner_caption: '不要错过奖励',
  referral_banner_title: '添加您的推荐码',
  kamino_banner_caption: 'Solana 的最新消息',
  kamino_banner_title: '加入 Kamino，开始赚钱吧！',
  from: '从',
  freeze: 'Freeze',
  ...
  solana_staking_move_notice:
    '转移质押需要多个步骤，并且会跨越多个纪元：此操作会立即停用账户，并开始大约{{days}}天的冷却期。冷却期结束后，再将质押转移到您选择的验证者。',
  ...
  swap_limit_blocker_same_asset: '选择两种不同的资产',
  ...
  swap_limit_cancel_title: '取消订单',
  swap_limit_cancel_verify_title: '您正在取消限价订单',
  swap_limit_cancel_order_label: '订单',
  swap_limit_cancel_explanation:
    '取消将关闭此订单并退还尚未成交的部分。已成交的部分将保持不变，不会退回。此操作需支付一次 THORChain 网络手续费。',
  swap_limit_cancel_donated_dust_row: 'THORChain 保留',
  swap_limit_cancel_duplicate_warning:
    '您还有另一个相同交易对和价格的挂单。THORChain 会优先取消最早匹配的订单，因此本次操作可能会关闭那个订单而非此订单。',
  swap_limit_cancel_order_changed:
    '您查看期间此订单已发生变化。请关闭此页面并查看其当前状态。',
  swap_limit_cancel_already_requested: '此订单的取消请求已发送，正在等待确认。',
  swap_limit_cancel_unavailable_legacy_order:
    '此订单创建于应用内取消功能推出之前，因此无法验证其详细信息。',
  swap_limit_cancel_unavailable_mismatch:
    '此订单的详细信息与 THORChain 报告的内容不一致，因此无法安全取消。',
  swap_limit_cancel_unavailable_memo_too_long:
    '此订单无法从其源链取消——取消消息对该网络而言过长。到期时将自动退款。',
  swap_limit_cancel_unavailable_chain:
    '不支持从此订单的出资链取消。到期时将自动退款。',
  swap_limit_cancel_unavailable_no_signing_asset:
    '请向此保险库添加 {{ticker}} 以取消此订单——取消交易将从 {{chain}} 发出。',
  swap_limit_cancel_view_transaction: '查看取消交易',
  swap_limit_cancel_sent: '取消已发送',
  swap_limit_cancel_sent_detail:
    '在 THORChain 确认订单关闭之前，您的订单仍然有效。',
  all_time_high: '历史最高价',
  all_time_low: '历史最低价',
  chart_range_all: '全部',
  chart_range_day: '1D',
  ...
  contract_address_copied: '合约地址已复制',
  decimals: '小数位数',
  fully_diluted_valuation: '完全稀释估值',
  high_24h: '24小时最高价',
  low_24h: '24小时最低价',
  market_cap: '市值',
  market_cap_rank: '排名',
  ...
  kamino_earn_entire_position: '这个保险库里的所有东西',
  kamino_earn_strands_wrapped_sol_rent:
    '这笔存款将开设一个 SOL 账户，该账户会持有少量 SOL，直到您提取为止。',
  ...
  swap_failed_refunded_description:
    '兑换未能完成，因此服务提供商将您的资金退回到您的钱包，而不是您请求的资产。实际上并未进行任何交易。请重试以获取新的报价。',
}
