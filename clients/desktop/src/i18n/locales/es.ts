export const es = {
  ...
  vault_details_page_vault_name: 'Nombre de la bóveda',
  ...
  vault_settings_page_title: 'Configuración',
  vault_settings_settings: 'Configuración de la bóveda',
  vault_settings_language: 'Idioma',
  vault_settings_currency: 'Moneda',
  ...
  vault_settings_section_other: 'Otros',
  ...
  vault_settings_edit_vault_details_title: 'Detalles',
  vault_setting_edit_vault_details_subtitle: 'Vea los detalles de su bóveda',
  vault_setting_edit_vault_backup_title: 'Respaldo',
  ...
  vault_rename_page_name_title: 'Nombre de la bóveda',
  vault_rename_page_submit_button_text: 'Guardar',
  ...
  vault_settings_address_book_add_addresses_button: 'Agregar dirección',
  or: 'o',
  ...
  vault_settings_address_book_address_address_field: 'Dirección',
  ...
  fastVaultSetup: {
    backup: {
      ...
      thisVault: 'esta copia de seguridad de la bóveda',
      backup: 'Hacer copia de seguridad',
  ...
  fast_vault_setup_prop_0: 'Solo se necesita 1 dispositivo',
  fast_vault_setup_prop_1: 'Almacena fondos pequeños para uso diario',
  fast_vault_setup_prop_2: 'Vultiserver firma al instante',
  ...
  secure_vault_setup_title: 'Seguridad Definitiva',
  secure_vault_setup_prop_0: 'Máxima seguridad con múltiples dispositivos',
  secure_vault_setup_prop_1:
    'Siempre accesible con copias de seguridad de dispositivos',
  secure_vault_setup_prop_2: 'Asegura cualquier cantidad de activos',
