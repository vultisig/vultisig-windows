export const es = {
  ...
  fast_vault_setup_prop_1: 'Almacena fondos pequeños para acciones rápidas',
  fast_vault_setup_prop_2:
    'La bóveda depende del tiempo de actividad del servidor',
  ...
  secure_vault_setup_prop_0: 'Control total, solo tus dispositivos',
  secure_vault_setup_prop_1: 'Varios dispositivos para firmar transacciones',
  secure_vault_setup_prop_2: 'Usar como bóveda fría',
