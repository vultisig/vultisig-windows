export const de = {
  ...
  fast_vault_setup_prop_1: 'Kleine Beträge für schnelle Aktionen speichern',
  fast_vault_setup_prop_2: 'Tresor ist von der Serververfügbarkeit abhängig',
  ...
  secure_vault_setup_prop_0: 'Volle Kontrolle, nur deine Geräte',
  secure_vault_setup_prop_1: 'Mehrere Geräte zur Transaktionssignierung',
  secure_vault_setup_prop_2: 'Als Cold Vault verwenden',
