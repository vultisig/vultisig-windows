export const de = {
  ...
  fastVaultSetup: {
    backup: {
      ...
      thisVault: 'dieses Tresor-Backup',
      backup: 'Sichern',
  ...
  fast_vault_setup_prop_0: 'Nur 1 Gerät erforderlich',
  fast_vault_setup_prop_1:
    'Kleinere Beträge für den täglichen Gebrauch speichern',
  fast_vault_setup_prop_2: 'Vultiserver unterzeichnet sofort',
  ...
  secure_vault_setup_title: 'Ultimative Sicherheit',
  secure_vault_setup_prop_0: 'Maximale Sicherheit mit mehreren Geräten',
  secure_vault_setup_prop_1: 'Immer zugänglich mit Geräte-Backups',
  secure_vault_setup_prop_2: 'Beliebige Menge an Vermögenswerten sichern',
