export const en = {
  ...
  fast_vault_setup_prop_1: 'Store small funds for quick actions',
  fast_vault_setup_prop_2: 'Vault relies on server uptime',
  ...
  secure_vault_setup_prop_0: 'Full control, only your devices',
  secure_vault_setup_prop_1: 'Multiple devices to sign transactions',
  secure_vault_setup_prop_2: 'Use as cold vault',
