export const en = {
  ...
  fastVaultSetup: {
    backup: {
      ...
      backUpNowVault: 'Back up now',
      backUp: 'Back up',
      backupVault: 'Back up Vault',
      shareOnlineBackup: 'online.',
      shareSecurely: 'share securely, preferably',
      backup: 'Back up',
  ...
  fast_vault_setup_prop_0: 'Only 1 device needed',
  fast_vault_setup_prop_1: 'Store smaller funds for daily use',
  fast_vault_setup_prop_2: 'Vultiserver co-signs instantly',
  ...
  secure_vault_setup_title: 'Ultimate Security',
  secure_vault_setup_prop_0: 'Maximum security with multiple devices',
  secure_vault_setup_prop_1: 'Always accessible with device backups',
  secure_vault_setup_prop_2: 'Secure any amount of assets',
