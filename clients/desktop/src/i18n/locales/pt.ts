export const pt = {
  ...
  chain_not_found_in_current_vault: 'Cadeia não encontrada no cofre atual',
  ...
  secure_vault_setup_prop_0: 'Máxima segurança com vários dispositivos',
  secure_vault_setup_prop_1: 'Sempre acessível com backups de dispositivos',
  secure_vault_setup_prop_2: 'Proteja qualquer quantidade de ativos',
  ...
  fast_vault_setup_prop_1: 'Armazene fundos menores para uso diário',
  fast_vault_setup_prop_2: 'Vultiserver assina instantaneamente',
