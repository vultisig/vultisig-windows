...
type EmailConfirmationSlidesProps = {
  vaultId: string;
  onCompleted: () => void;
};

export const EmailConfirmationSlides: FC<EmailConfirmationSlidesProps> = ({
  vaultId,
  onCompleted,
}) => {
        ...
        <VStack flexGrow gap={12}>
          <VStack>
            <Text variant="h1Regular">
              Enter the 5 digit code we emailed you
            </Text>
            <Text size={14} color="shy">
              This code will confirm that you’ve received your vault share 1 via
              email
            </Text>
          </VStack>
          <VStack gap={4}>
