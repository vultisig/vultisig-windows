...
// WASM. If you add MPC code paths here, await `loadMpcEngine` from that module
// before the first engine call and confirm the bundle-size impact. Types-only imports from
