...
export type ExtensionBrandConfig = {
  ...
  provider: ExtensionProviderBrandConfig
}

const vultisigExtensionBrandConfig: ExtensionBrandConfig = {
  brand: 'vultisig',
  ...
  provider: {
    eip6963Name: 'Vultisig',
    eip6963Rdns: 'me.vultisig',
    icon: vultisigIconDataUri,
    solanaName: 'Vultisig',
    walletPickerIdentifier: 'vultisig',
    walletPickerName: 'Vultisig',
  },
}

const stationExtensionBrandConfig: ExtensionBrandConfig = {
  brand: 'station',
  ...
  provider: {
    eip6963Name: 'Station Wallet',
    eip6963Rdns: 'money.station',
    icon: stationIconDataUri,
    solanaName: 'Station',
    walletPickerIdentifier: 'station',
    walletPickerName: 'Station',
  },
}

export const extensionBrandConfigs: Record<
  ExtensionProductBrand,
  ExtensionBrandConfig
> = {
  vultisig: vultisigExtensionBrandConfig,
  station: stationExtensionBrandConfig,
}

export const resolveExtensionProductBrand = (
  value?: string
): ExtensionProductBrand => {
  if (!value || value === defaultExtensionProductBrand) {
    return defaultExtensionProductBrand
  }
...
const getCurrentExtensionProductBrand = () => {
  if (typeof __VULTISIG_PRODUCT_BRAND__ !== 'undefined') {
    return resolveExtensionProductBrand(__VULTISIG_PRODUCT_BRAND__)
  }

  return defaultExtensionProductBrand
}

export const getExtensionBrandConfig = (brand: ExtensionProductBrand) =>
  extensionBrandConfigs[brand]

export const currentExtensionBrandConfig =
  getCurrentExtensionProductBrand() === 'station'
    ? stationExtensionBrandConfig
    : vultisigExtensionBrandConfig
